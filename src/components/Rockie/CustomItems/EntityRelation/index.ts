...
export const ERCustomShapes = [
    ...
    { name: ERCustomShapeTypes[6].name, type: ERCustomShape, typeInfo: ERCustomShapeTypes[6] },
    { name: ERCustomShapeTypes[7].name, type: ERCustomShape, typeInfo: ERCustomShapeTypes[7] },
]