...
export class UMLCustomTable extends CustomTableEntity {
  ...
  private refreshGrid() {
    const cellWidth = (this.customTableeType.fixedFirstColumn && this.customTableeType.columnCount > 1) ? (this.width - this.customTableeType.firstColumnWidth) / (this.customTableeType.columnCount - 1) : this.width / this.customTableeType.columnCount
    const cellHeight = (this.customTableeType.fixedFirstRow && this.customTableeType.rowCount > 1) ? (this.height - this.customTableeType.firstRowHeight) / (this.customTableeType.rowCount - 1) : this.height / this.customTableeType.rowCount
