...
export class EntityShape extends AbstractTextShape {
  ...
  constructor(text = '', left = 0, top = 0, width = 100, height = 100, typeInfo: ShapeTypeInfo = {
    ...
    this.secondStroke.setStrokeWidth(this.stroke.getStroketWidth())
    ...
    this.thirdStroke.setStrokeWidth(this.stroke.getStroketWidth())
    ...
    this.fourthStroke.setStrokeWidth(this.stroke.getStroketWidth())
