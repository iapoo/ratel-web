...
export const ConnectorArrowTypes = [
  ...
  {name: 'Ellipse-3', description: 'Ellipse', type: ConnectorArrowDisplayType.Ellipse, height: 12, width: 12, modifier: 0, count: 2, outline: false, close: true, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Ellipse-4', description: 'Ellipse', type: ConnectorArrowDisplayType.Ellipse, height: 12, width: 12, modifier: 0, count: 2, outline: true, close: true, displayMode: ConnectorArrowDisplayMode.Full, },

  {name: 'Other-1', description: '(', type: ConnectorArrowDisplayType.LeftParenthesis, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-2', description: ')', type: ConnectorArrowDisplayType.RightParenthesis, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-3', description: 'X', type: ConnectorArrowDisplayType.Orthogonal, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-4', description: '/', type: ConnectorArrowDisplayType.ForewardSlash, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-5', description: '\\', type: ConnectorArrowDisplayType.Backslashe, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-6', description: '|', type: ConnectorArrowDisplayType.VerticalLine, height: 12, width: 12, modifier: 0.4, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-7', description: '<', type: ConnectorArrowDisplayType.LeftAngleBracket, height: 12, width: 12, modifier: 0, count: 1, outline: true, close: false, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-8', description: '|<', type: ConnectorArrowDisplayType.VerticaleLineAndLeftAngleBacket, height: 12, width: 12, modifier: 0, count: 1, outline: false, close: true, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-9', description: 'o|', type: ConnectorArrowDisplayType.CircleAndVerticalLine, height: 12, width: 24, modifier: 0, count: 1, outline: true, close: true, displayMode: ConnectorArrowDisplayMode.Full, },
  {name: 'Other-10', description: 'o<', type: ConnectorArrowDisplayType.CircleAndLeftBacket, height: 12, width: 24, modifier: 0, count: 1, outline: true,close: true,  displayMode: ConnectorArrowDisplayMode.Full, },
