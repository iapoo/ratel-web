...
export class ImageContainerInfo extends EditorItemInfo {
  ...
  public constructor (type = 'CustomSvgShape', category = 'CustomSvgShape', left = 0, top = 0, width = 100, height = 100, text = ''
