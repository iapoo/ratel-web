...
export class RequestUtils {
  ...
  public static logout() {
    ...
    axios
      .post(`${RequestUtils.systemServerAddress}/logout`, data, config)
      .then((response) => {
        if (response.status === 200 && response.data.success) {
  ...
  public static info() {
    return axios.post(
      `${RequestUtils.systemServerAddress}/info`,
      {},
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  public static getSettings() {
    return axios.post(
      `${RequestUtils.systemServerAddress}/settings`,
      {},
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  public static updateSettings(settings: string) {
    return axios.post(
      `${RequestUtils.systemServerAddress}/updateSettings`,
      {
        settings: settings,
      },
      {
  ...
  public static updateDocumentShare(
    documentId: number,
    shareStatus: number,
    shareCode: string,
  ...
  public static getOperatorCustomers(
    like: string | null,
  ...
  public static getDocumentAccessDetails(
    documentId: number,
    like: string | null,
    pageNum: number = 1,
    pageSize: number = 8,
  ...
  public static getDocumentTeamAccessDetails(
    documentId: number,
    like: string | null,
    pageNum: number = 1,
    pageSize: number = 8,
