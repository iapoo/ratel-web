...
import {
  ShapeEntity,
  ShapeType,
} from "@/components/Rockie/Items/src/ShapeEntity";
...
const Navigator: FC<NavigatorProps> = ({
  ...
  const [myShapesWindowVisiible, setMyShapesWindowVisible] = useState<boolean>(
    false
  );
  ...
  const addEllipse = () => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new ShapeAction(
        Utils.currentEditor,
        Shapes.TYPE_ELLIPSE
      );
    }
  ...
  const addShape = (type: string, folder: string) => {
    if (Utils.currentEditor) {
      ...
      Utils.currentEditor.action.imageId =
        process.env.PUBLIC_PATH + `/${folder}/${type}.png`;
    }
  };

  const addContainer = (type: string, folder: string) => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new ContainerAction(
        Utils.currentEditor,
        type
      );
      Utils.currentEditor.action.imageId =
  ...
  const addCustomShape = (
    type: string,
    classType: typeof CustomEntity,
    shapeType: ShapeType,
    folder: string
  ) => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new CustomShapeAction(
        Utils.currentEditor,
        type,
        classType,
        shapeType
  ...
  const addCustomContainer = (
    ...
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new CustomContainerAction(
        Utils.currentEditor,
        type,
        classType,
        shapeType
  ...
  const addFrame = (
    type: string,
    classType: typeof FrameEntity,
    shapeType: ShapeType,
    folder: string
  ) => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new FrameAction(
        Utils.currentEditor,
        type,
        classType,
        shapeType
  ...
  const addSvgShape = (
    ...
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new SvgContainerAction(
        Utils.currentEditor,
        type,
        data,
        width,
  ...
  const addImageShape = (
    ...
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new ImageContainerAction(
        Utils.currentEditor,
        type,
        data,
        width,
  ...
  const addMyShape = (myShape: MyShape) => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new MyShapeAction(
        Utils.currentEditor,
        myShape
      );
      Utils.currentEditor.action.imageId =
  ...
  const addCustomTable = (
    ...
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new CustomTableAction(
        Utils.currentEditor,
        typeName,
        classType,
        shapeType
      ...
      Utils.currentEditor.action.imageId =
        process.env.PUBLIC_PATH + `/${folder}/${typeName}.png`;
    }
  };
  ...
  const addExtendedContainer = (
    ...
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new ExtendedContainerAction(
        Utils.currentEditor,
        typeName,
        classType,
        shapeType
  ...
  const addExtendedShape = (
    type: string,
    classType: typeof ShapeEntity,
    shapeType: ShapeType,
    folder: string
  ) => {
    if (Utils.currentEditor) {
      Utils.currentEditor.action = new ExtendedShapeAction(
        Utils.currentEditor,
        type,
        classType,
        shapeType
  ...
  const getPopoverContent = (name: string, width: number, height: number) => {
    return (
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={process.env.PUBLIC_PATH + `/shapes-large/${name}.png`}
            src={process.env.PUBLIC_PATH + `/shapes-large/${name}.png`}
          />
        </div>
      </div>
    );
  ...
  const getCustomShapeBasicShapesPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
        ...
        >
          <img
            id={
              ...
              `/custom-shapes-large/basic-shapes/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/basic-shapes/${name}.png`
  ...
  const getCustomShapeAliyunPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
      ...
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/aliyun/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/aliyun/${name}.png`
  ...
  const getCustomShapeAwsPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
    return (
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={
              process.env.PUBLIC_PATH + `/custom-shapes-large/aws/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH + `/custom-shapes-large/aws/${name}.png`
            }
  ...
  const getCustomShapeArrowsPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
      ...
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/arrows/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/arrows/${name}.png`
  ...
  const getCustomShapeFlowChartShapesPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
      ...
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/flowchart/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes-large/flowchart/${name}.png`
  ...
  const getCustomShapeUMLPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
    return (
      <div style={{ width: width * 1.25, display: "table" }}>
        ...
        >
          <img
            id={
              process.env.PUBLIC_PATH + `/custom-shapes-large/uml/${name}.png`
            }
            src={
              process.env.PUBLIC_PATH + `/custom-shapes-large/uml/${name}.png`
            }
  ...
  const getUMLContainerPopoverContent = (
    name: string,
    width: number,
    height: number
  ) => {
  ...
  const line = (
    <Popover
      title={"Line"}
      placement="right"
      content={getPopoverContent("Line", 128, 128)}
      overlayStyle={{
    ...
    >
      <Button
        type="text"
        onMouseDown={() => addLine("Line", "shapes-large")}
        style={{ padding: 2, display: "table" }}
      >
        <img
          id={process.env.PUBLIC_PATH + `/shapes/Line.png`}
          src={process.env.PUBLIC_PATH + `/shapes/Line.png`}
          width={28}
          height={28}
  ...
  const table = (
    <Popover
      title={"Table"}
      placement="right"
      content={getPopoverContent("Table", 128, 128)}
      overlayStyle={{
        left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
        minWidth: 180,
        width: 180,
    ...
    >
      <Button
        type="text"
        onMouseDown={() => addTable("Table", "shapes-large")}
        style={{ padding: 2, display: "table" }}
      >
        <img
          id={process.env.PUBLIC_PATH + `/shapes/Table.png`}
          src={process.env.PUBLIC_PATH + `/shapes/Table.png`}
          width={28}
          height={28}
          style={{ display: "table-cell" }}
        />
  ...
  const connector = (
    ...
    >
      ...
      >
        <img
          id={process.env.PUBLIC_PATH + `/shapes/Connector.png`}
          src={process.env.PUBLIC_PATH + `/shapes/Connector.png`}
          width={28}
          height={28}
          style={{ display: "table-cell" }}
        />
  ...
  const handleDragStart = (
    ...
    addShape(name);
    const largeImae = document.getElementById(
      process.env.PUBLIC_PATH + `/shapes-large/${name}.png`
    );
  ...
  const shapes = ShapeTypes.map((shapeType) => {
    ...
    return (
      ...
      >
        <Button
          type="text"
          onMouseDown={() => addShape(shapeType.name, "shapes-large")}
          style={{ padding: 2, display: "table" }}
        >
          <img
            src={process.env.PUBLIC_PATH + `/shapes/${shapeType.name}.png`}
            width={width}
            height={height}
            style={{ display: "table-cell" }}
            draggable={false}
  ...
  const containers2 = (
    <Popover
      title={"Container"}
      placement="right"
      content={getPopoverContent("Rectangle", 128, 128)}
      overlayStyle={{
        left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
        minWidth: 180,
        width: 180,
    ...
    >
      <Button
        type="text"
        onMouseDown={() =>
          addContainer(Containers.TYPE_CONTAINER, "shapes-large")
        }
        style={{ padding: 2, display: "table" }}
      >
        <img
          src={process.env.PUBLIC_PATH + `/shapes/Rectangle.png`}
          width={28}
          height={19}
          style={{ display: "table-cell" }}
        />
  ...
  const containers = ContainerTypes.map((containerType) => {
    return (
      ...
      >
        <Button
          type="text"
          onMouseDown={() => addContainer(containerType.name, "shapes-large")}
          style={{ padding: 2, display: "table" }}
        >
          <img
            src={process.env.PUBLIC_PATH + `/shapes/${containerType.name}.png`}
            width={28}
            height={28}
            style={{ display: "table-cell" }}
          />
  ...
  const customShapeBasicShapes = BasicShapes.map((basicType) => {
    return (
      <Popover
        title={basicType.typeInfo.description}
        placement="right"
        content={getCustomShapeBasicShapesPopoverContent(
          basicType.name,
          basicType.typeInfo.width,
          basicType.typeInfo.height
        )}
        overlayStyle={{
          left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
          minWidth: 160,
        ...
        <Button
          ...
          onMouseDown={() =>
            addCustomShape(
              ...
              basicType.type,
              basicType.typeInfo,
              "custom-shapes-large/basic-shapes"
            )
          }
          style={{ padding: 2, display: "table" }}
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/basic-shapes/${basicType.name}.png`
            }
            width={28}
            height={28}
            style={{ display: "table-cell" }}
  ...
  const customShapeFlowChartShapes = FlowChartShapes.map((basicType) => {
    let width = 28;
    let height = 28;
    if (basicType.typeInfo.width > basicType.typeInfo.height) {
      height = Math.round(
        (28 * basicType.typeInfo.height) / basicType.typeInfo.width
      );
    } else {
      width = 28;
    }
    return (
      <Popover
        title={basicType.typeInfo.description}
        placement="right"
        content={getCustomShapeFlowChartShapesPopoverContent(
          basicType.name,
          basicType.typeInfo.width,
          basicType.typeInfo.height
        )}
      ...
      >
        ...
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/flowchart/${basicType.name}.png`
            }
            width={width}
            height={height}
            style={{ display: "table-cell" }}
  ...
  const customShapeArrows = Arrows.map((arrow) => {
    let width = 28;
    let height = 28;
    ...
    return (
      <Popover
        title={arrow.typeInfo.description}
        placement="right"
        content={getCustomShapeArrowsPopoverContent(
          arrow.name,
          arrow.typeInfo.width,
          arrow.typeInfo.height
        )}
        overlayStyle={{
          left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
          minWidth: 180,
      ...
      >
        ...
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/arrows/${arrow.name}.png`
            }
            width={width}
            height={height}
            style={{ display: "table-cell" }}
  ...
  const aliyunShapes = AliyunShapes.map((shapeType) => {
    return (
      <Popover
        title={shapeType.name}
        placement="right"
        content={getCustomShapeAliyunPopoverContent(
          shapeType.name,
          shapeType.width,
          shapeType.height
        )}
      ...
      >
        ...
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/aliyun/${shapeType.name}.png`
            }
            width={28}
            height={28}
            style={{ display: "table-cell" }}
  ...
  const awsShapes = AwsShapes.map((shapeType) => {
    return (
      <Popover
        title={shapeType.name}
        placement="right"
        content={getCustomShapeAwsPopoverContent(
          shapeType.name,
          shapeType.width,
          shapeType.height
        )}
      ...
      >
        ...
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/aws/${shapeType.name}.png`
            }
            width={28}
            height={28}
            style={{ display: "table-cell" }}
      ...
      >
        ...
        >
          <img
            src={
              process.env.PUBLIC_PATH +
              `/custom-shapes/uml/${shapeType.name}.png`
            }
            width={28}
            height={28}
            style={{ display: "table-cell" }}
  ...
  const umlContainerShapes = UMLContainerShapes.map((shapeType) => {
    return (
      <Popover
        title={shapeType.name}
        placement="right"
        content={getUMLContainerPopoverContent(
          shapeType.name,
          shapeType.typeInfo.width,
          shapeType.typeInfo.height
        )}
  ...
  const umlBasicShapes = UMLBasicShapes.map((shapeType) => {
    return (
      <Popover
        title={shapeType.name}
        placement="right"
        content={getCustomShapeUMLPopoverContent(
          shapeType.name,
          shapeType.typeInfo.width,
          shapeType.typeInfo.height
        )}
  ...
  const umlGridShapesForClass = UMLGridShapesForClass.map((shapeType) => {
    return (
      <Popover
        ...
        overlayStyle={{
          left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
          minWidth: shapeType.typeInfo.width + 60,
          width: shapeType.typeInfo.height + 60,
        }}
      >
        <Button
          type="text"
  ...
  const umlContainerShapesForActivityState = UMLContainerShapesForActivityState.map(
    (shapeType) => {
      const iconWidth =
        shapeType.typeInfo.width >= shapeType.typeInfo.height
          ? 28
          : (28 * shapeType.typeInfo.width) / shapeType.typeInfo.height;
      const iconheight =
        shapeType.typeInfo.width >= shapeType.typeInfo.height
          ? (28 * shapeType.typeInfo.height) / shapeType.typeInfo.width
          : 28;
      ...
      return (
        <Popover
          ...
          overlayStyle={{
            left: navigatorWidth + Utils.DEFAULT_DIVIDER_WIDTH,
            minWidth: shapeType.typeInfo.width + 60,
            width: shapeType.typeInfo.width + 60,
          }}
        >
          <Button
            type="text"
  ...
  const myShapeItems = myShapes.map((myShape) => {
    const width =
      myShape.width > myShape.height
        ? 28
        : Math.round((28 * myShape.width) / myShape.height);
    const height =
      myShape.height > myShape.width
        ? 28
        : Math.round((28 * myShape.height) / myShape.width);
    return (
      <Button
        type="text"
        onMouseDown={() => addMyShape(myShape)}
        style={{
          padding: 2,
          display: "flex",
  ...
  return (
    ...
    >
      ...
      />
      <MyShapesWindowPage
        visible={myShapesWindowVisiible}
