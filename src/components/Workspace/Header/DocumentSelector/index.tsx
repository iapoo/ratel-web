...
const DocumentWindowPage: FC<DocumentWindowProps> = ({ visible, onWindowCancel, onWindowOk }) => {
  ...
  const columns: ProColumns<SingleDocumentType>[] = [
    ...
    },
    {
      ...
      render: (text: any) => {
        return (
          <div style={{ width: '120px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {text}
          </div>
        )
      },
    ...
    },
    {
      ...
      render: (text: any) => {
        return (
          <div style={{ width: '90px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {text}
          </div>
        )
      },
  ...
  return (
    <div>
      <Modal
        title={<FormattedMessage id="workspace.header.document-selector-window.title" />}
        width={1100}
        centered
        open={visible}
        onOk={onOk}
                  ...
                  <Col span={18}>
                    <Input
                      ...
                      placeholder={intl.formatMessage({
                        id: 'workspace.header.document-selector-window.search-placeholder',
                      })}
                    ...
                    <Button key="searchButton" type="primary" style={{ marginLeft: '24px' }} onClick={handleSearch}>
                      <FormattedMessage id="workspace.header.document-selector-window.button-search" />
                    </Button>
                  </Col>
                </Row>,
              ]}
