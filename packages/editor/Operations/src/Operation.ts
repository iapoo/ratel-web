...
export class Operation {
  ...
  public constructor(
    editor: Editor,
    type: OperationType,
    itemInfos: Array<EditorItemInfo>,
    selected: boolean = false,
    origItemInfos: Array<EditorItemInfo> = [],
    description: string = '',
    afterEditor: Editor | null = null,
    afterItemId: string | null = null,
    beforeEditor: Editor | null = null,
    beforeItemId: string | null = null,
    inTextEditting: boolean = false,
    textStart: number = 0,
    textEnd: number = 0,
    origTextStart: number = 0,
    origTextEnd: number = 0,
    editorTitle: string = '',
    origEditorTitle: string = '',
    origEditor: Editor | null = null,
    tableCellIndex: number = 0,
    documentThemeName: string = '',
    origDocumentThemeName: string = '',
  ) {
    this._editor = editor
    this._type = type
