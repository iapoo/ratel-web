...
import { CustomImageShape, EntityShapeType } from '../../Shapes'
...
export const ImageContainerTypes = [
  {
    name: TYPE_IMAGE_CONTAINER,
    description: DESC_IMAGE_CONTAINER,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_IMAGE_CONTAINER,
    left: 0,
    top: 0,
    width: 100,
    height: 100,
