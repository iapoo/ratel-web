...
import { EntityShapeType, GroupShape } from '../../Shapes'
...
export const GroupEntityTypes = [
  {
    name: GroupEntities.TYPE_GROUP_SHAPE,
    description: GroupEntities.DESC_GROUP_SHAPE,
