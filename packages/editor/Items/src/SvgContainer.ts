import { Color } from '@ratel-web/engine'
import { CustomSvgShape, EntityShapeType } from '../../Shapes'
...
export const SvgContainerTypes = [
  {
    name: TYPE_SVG_CONTAINER,
    description: DESC_SVG_CONTAINER,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_SVG_CONTAINER,
    left: 0,
    top: 0,
    width: 100,
    height: 100,
