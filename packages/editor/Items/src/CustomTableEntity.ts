...
const CustomTableTypes: CustomTableType[] = [
  {
    name: CustomTableEntities.TYPE_CUSTOMER_TABLE,
    description: CustomTableEntities.DESC_CUSTOMER_TABLE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: CustomTableEntities.TEXT_CUSTOMER_TABLE,
    left: 0,
    top: 0,
    width: 250,
    height: 160,
...
export class CustomTableEntity extends TableEntity {
  ...
  public constructor(
    ...
    width: number,
    height: number,
    customTableeTypeName: string = CustomTableEntities.TYPE_CUSTOMER_TABLE,
    customTableTypeInfos: CustomTableType[] = CustomTableTypes,
    rowCount = 2,
    columnCount = 1,
  ) {
