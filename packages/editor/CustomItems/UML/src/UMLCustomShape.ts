import { FontWeight, Rectangle, TextDecoration } from '@ratel-web/engine'
...
export const UMLCustomShapeTypes = [
  {
    name: UMLCustomShapes.TYPE_ACTIVATION,
    description: UMLCustomShapes.DESC_ACTIVATION,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomShapes.TEXT_ACTIVATION,
    left: 0,
    top: 0,
    width: 20,
    height: 80,
  ...
  {
    name: UMLCustomShapes.TYPE_FINAL_NODE,
    description: UMLCustomShapes.DESC_FINAL_NODE,
    freeze: ShapeConstants.FREEZE_ASPECT_RATIO,
    text: UMLCustomShapes.TEXT_FINAL_NODE,
    left: 0,
    top: 0,
    width: 40,
    height: 40,
  ...
  {
    name: UMLCustomShapes.TYPE_NODE,
    description: UMLCustomShapes.DESC_NODE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomShapes.TEXT_NODE,
    left: 0,
    top: 0,
    width: 120,
    height: 100,
  ...
  {
    name: UMLCustomShapes.TYPE_NODE_2,
    description: UMLCustomShapes.DESC_NODE_2,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomShapes.TEXT_NODE_2,
    left: 0,
    top: 0,
    width: 120,
    height: 100,
  ...
  {
    name: UMLCustomShapes.TYPE_MODULE,
    description: UMLCustomShapes.DESC_MODULE,
    freeze: ShapeConstants.FREEZE_ASPECT_RATIO,
    text: UMLCustomShapes.TEXT_MODULE,
    left: 0,
    top: 0,
    width: 120,
    height: 60,
  ...
  {
    name: UMLCustomShapes.TYPE_COMPONENT,
    description: UMLCustomShapes.DESC_COMPONENT,
    freeze: ShapeConstants.FREEZE_ASPECT_RATIO,
    text: UMLCustomShapes.TEXT_COMPONENT,
    left: 0,
    top: 0,
    width: 180,
    height: 100,
  ...
  {
    name: UMLCustomShapes.TYPE_LOLLIPOP_NOTATION,
    description: UMLCustomShapes.DESC_LOLLIPOP_NOTATION,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomShapes.TEXT_LOLLIPOP_NOTATION,
    left: 0,
    top: 0,
    width: 80,
    height: 40,
  ...
  {
    name: UMLCustomShapes.TYPE_REQUIRED_INTERFACE,
    description: UMLCustomShapes.DESC_REQUIRED_INTERFACE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomShapes.TEXT_REQUIRED_INTERFACE,
    left: 0,
    top: 0,
    width: 60,
    height: 40,
  ...
  {
    name: UMLCustomShapes.TYPE_INITIAL_NODE,
    description: UMLCustomShapes.DESC_INITIAL_NODE,
    freeze: ShapeConstants.FREEZE_ASPECT_RATIO,
    text: UMLCustomShapes.TEXT_INITIAL_NODE,
    left: 0,
    top: 0,
    width: 40,
    height: 40,
