...
import { Categories, ContainerEntity, ShapeConstants, ShapeOptions, ShapeType, Type } from '../../../Items'
...
export const UMLContainerTypes = [
  {
    name: UMLContainers.TYPE_PACKAGE,
    description: UMLContainers.DESC_PACKAGE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLContainers.TEXT_PACKAGE,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLContainers.TYPE_CONTAINER,
    description: UMLContainers.DESC_CONTAINER,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLContainers.TEXT_CONTAINER,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLContainers.TYPE_HORIZONTAL_POOL,
    description: UMLContainers.DESC_HORIZONTAL_POOL,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLContainers.TEXT_HORIZONTAL_POOL,
    left: 0,
    top: 0,
    width: 300,
    height: 160,
  ...
  {
    name: UMLContainers.TYPE_VERTICAL_POOL,
    description: UMLContainers.DESC_VERTICAL_POOL,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLContainers.TEXT_VERTICAL_POOL,
    left: 0,
    top: 0,
    width: 160,
    height: 300,
...
export class UMLContainerShape extends ContainerEntity {
  public constructor(
    ...
    width: number,
    height: number,
    shapeOptions: ShapeOptions = { shapeType: UMLContainers.TYPE_PACKAGE },
    shapeTypes: ShapeType[] = UMLContainerTypes,
  ) {
