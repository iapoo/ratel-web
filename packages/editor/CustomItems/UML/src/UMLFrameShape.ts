...
export const UMLFrameShapeTypes: ShapeType[] = [
  {
    name: UMLFrameShapes.TYPE_LOOP,
    description: UMLFrameShapes.DESC_LOOP,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLFrameShapes.TEXT_LOOP,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLFrameShapes.TYPE_OPT,
    description: UMLFrameShapes.DESC_OPT,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLFrameShapes.TEXT_OPT,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLFrameShapes.TYPE_ALT,
    description: UMLFrameShapes.DESC_ALT,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLFrameShapes.TEXT_ALT,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLFrameShapes.TYPE_PAR,
    description: UMLFrameShapes.DESC_PAR,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLFrameShapes.TEXT_PAR,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
  ...
  {
    name: UMLFrameShapes.TYPE_OTHER,
    description: UMLFrameShapes.DESC_OTHER,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLFrameShapes.TEXT_OTHER,
    left: 0,
    top: 0,
    width: 200,
    height: 200,
