import { Rectangle, StrokeDashStyle } from '@ratel-web/engine'
import { CustomContainerEntity, ShapeConstants, ShapeType, Type } from '../../../Items'
...
export const UMLCustomContainerTypes = [
  {
    name: UMLCustomContainers.TYPE_ACTOR_LIFELINE,
    description: UMLCustomContainers.DESC_ACTOR_LIFELINE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomContainers.TEXT_ACTOR_LIFELINE,
    left: 0,
    top: 0,
    width: 20,
    height: 200,
  ...
  {
    name: UMLCustomContainers.TYPE_OBJECT_LIFELINE,
    description: UMLCustomContainers.DESC_OBJECT_LIFELINE,
    freeze: ShapeConstants.FREEZE_NONE,
    text: UMLCustomContainers.TEXT_OBJECT_LIFELINE,
    left: 0,
    top: 0,
    width: 80,
    height: 200,
