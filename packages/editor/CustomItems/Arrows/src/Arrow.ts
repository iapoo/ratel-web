...
export const ArrowTypes = [
  {
    name: TYPE_ARROW_RIGHT,
    description: DESC_ARROW_RIGHT,
  ...
  {
    name: TYPE_ARROW_LEFT,
    description: DESC_ARROW_LEFT,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
  ...
  {
    name: TYPE_ARROW_BOTTOM,
    description: DESC_ARROW_BOTTOM,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
  ...
  {
    name: TYPE_ARROW_BOTH_WAY_HORIZONTAL,
    description: DESC_ARROW_BOTH_WAY_HORIZONTAL,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
  ...
  {
    name: TYPE_ARROW_BOTH_WAY_VERTICAL,
    description: DESC_ARROW_BOTH_WAY_VERTICAL,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
  ...
  {
    name: TYPE_ARROW_JUMP_IN_LEFT,
    description: DESC_ARROW_JUMP_IN_LEFT,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
  ...
  {
    name: TYPE_ARROW_JUMP_IN_RIGHT,
    description: DESC_ARROW_JUMP_IN_RIGHT,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_ARROW,
    left: 0,
    top: 0,
