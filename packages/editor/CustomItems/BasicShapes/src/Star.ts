...
import { CustomShape, EntityShape, EntityShapeType } from '../../../Shapes'

const TYPE_STAR_4 = 'Star4'
const DESC_STAR_4 = '4 Point Star'
const TYPE_STAR_5 = 'Star5'
const DESC_STAR_5 = '5 Point Star'
const TYPE_STAR_6 = 'Star6'
const DESC_STAR_6 = '6 Point Star'
const TYPE_STAR_7 = 'Star7'
const DESC_STAR_7 = '7 Point Star'
const TYPE_STAR_8 = 'Star8'
const DESC_STAR_8 = '8 Point Star'
const TYPE_STAR_16 = 'Star16'
const DESC_STAR_16 = '16 Point Star'
const TYPE_STAR_24 = 'Star24'
const DESC_STAR_24 = '24 Point Star'
const TYPE_STAR_32 = 'Star32'
const DESC_STAR_32 = '32 Point Star'
const TEXT_STAR = ''

export const StarTypes = [
  {
    name: TYPE_STAR_4,
    description: DESC_STAR_4,
