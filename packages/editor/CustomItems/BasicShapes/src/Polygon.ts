import { MathUtils } from '@ratel-web/engine'
...
export const PolygonTypes = [
  ...
  {
    name: TYPE_POLYGON_10,
    description: DESC_POLYGON_10,
    freeze: ShapeConstants.FREEZE_NONE,
    text: TEXT_POLYGON,
    left: 0,
    top: 0,
