...
import { DocumentThemeType, DocumentThemeTypes } from './DocumentTheme'
...
export class ThemeUtils {
  ...
  public static getShapeStrokeColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.shapeStrokeColor)
      if (color) {
        return color
      } else {
        return Colors.Black
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].shapeStrokeColor)
      if (color) {
        return color
      } else {
        return Colors.Black
  ...
  public static getShapeFillColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.shapeFillColor)
      if (color) {
        return color
      } else {
        return Colors.White
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].shapeFillColor)
      if (color) {
        return color
      } else {
        return Colors.White
  ...
  public static getShapeFontColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.shapeFontColor)
      if (color) {
        return color
      } else {
        return Colors.Black
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].shapeFontColor)
      if (color) {
        return color
      } else {
        return Colors.Black
  ...
  public static getConnectorStrokeColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.connectorStrokeColor)
      if (color) {
        return color
      } else {
        return Colors.Black
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].connectorStrokeColor)
      if (color) {
        return color
      } else {
        return Colors.Black
  ...
  public static getConnectorFillColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.connectorFillColor)
      if (color) {
        return color
      } else {
        return Colors.White
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].connectorFillColor)
      if (color) {
        return color
      } else {
        return Colors.White
  ...
  public static getConnectorFontColor(themeName: string): Color {
    ...
    const documentThemeType = ThemeUtils.documentThemeMap.get(themeName)
    if (documentThemeType) {
      const color = CommonUtils.parseColorString(documentThemeType.connectorFontColor)
      if (color) {
        return color
      } else {
        return Colors.Black
      ...
      const color = CommonUtils.parseColorString(DocumentThemeTypes[0].connectorFontColor)
      if (color) {
        return color
      } else {
        return Colors.Black
