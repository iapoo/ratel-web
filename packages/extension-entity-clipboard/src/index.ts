...
import { RenderContext, ShapeConstants } from '@ratel-web/editor/Items'
import { EntityExtension } from '@ratel-web/editor/Items/src/EntityExtensions'

export function loadEntities(): EntityExtension[] {
  return [
    {
      name: 'star',
      description: 'star',
